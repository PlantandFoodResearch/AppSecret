#' Application Secrets
#'
#' @description A simple way to symmetrically encrypt information and store
#' on disk.
#'
#' @details The goal of AppSecret is to manage application secrets for users,
...
#' @name AppSecret-package
#' @aliases AppSecret
#' @docType package
#' @author Roy Storey \email{roy.storey@plantandfood.co.nz}
#' @keywords package symmetric encryption AES-256
#'
#' @section Usage:
